...
public class WebRTCSigApi {
    ...
    public static void main(String[] args) {
        int sdkappid = 1400118134;   //腾讯云云通信sdkappid
        ...
        try {
            ...
            File privateKeyFile = ResourceUtils.getFile("classpath:private_key");

            byte[] privateKey = new byte[(int)privateKeyFile.length()];

            //File publicKeyFile = new File("public_key");

            File publicKeyFile = ResourceUtils.getFile("classpath:public_key");
